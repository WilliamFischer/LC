...
.controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
  ...
  $scope.projectsList = $firebase(new Firebase("https://lootcard.firebaseio.com/projects"));
  $scope.user = $firebase(new Firebase("https://lootcard.firebaseio.com/Users/John"));
